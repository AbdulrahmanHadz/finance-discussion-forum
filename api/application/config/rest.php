...
$config['strict_api_and_auth'] = false; // force the use of both api and auth before a
// valid api request is made
...
|
*/
$config['forced_cors_headers'] = ['Access-Control-Allow-Origin' => '*'];
